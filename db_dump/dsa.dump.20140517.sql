...
CREATE TABLE char_weapons (
    ...
    wm character varying(8) DEFAULT '0/0'::character varying,
...
COPY char_weapons (id, character_id, weapon_id, ini, wm, at, pa, bf, tp, tpkk) FROM stdin;
\.
...
SELECT pg_catalog.setval('char_weapons_id_seq', 1, false);
...
SELECT pg_catalog.setval('weapons_id_seq', 3, true);
